...
const KnowledgeBaseScreen: React.FC<KnowledgeBaseScreenProps> = ({ navigateTo }) => {
  ...
  return (
    <SidebarMainLayout navigateTo={navigateTo} activeScreen={Screen.KnowledgeBase}>
      <Header title="Knowledge Base" showUserProfile />
